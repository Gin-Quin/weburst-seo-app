			...
			{#each tooltipCtx.payload as item, i (item.key + i)}
				...
				>
					...
					{:else}
						...
						<div
							class={cn(
								"flex flex-1 shrink-0 justify-between leading-none gap-2 items-center",
								nestLabel ? "items-end" : "items-center",
							)}
						>
							<div class="grid gap-1.5 items-center">
								{#if nestLabel}
									{@render TooltipLabel()}
								{/if}
								<span class="text-muted-foreground translate-y-[-1px]">
